...
`https://raw.githubusercontent.com/joeoliveimpact/legit-pdf2md/legit-pdf2md--v0.2.0-rc1/plugins/legit-pdf2md/skills/legit-pdf2md/scripts/` + `clean_gdoc_md.py` or `drive_txn.py`
